...
/*   Updated: 2025/06/08 21:25:38 by gapachec         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param last_meal_time The timestamp (in milliseconds) of the philosopher's
 * last meal.
 ...
 * * This structure holds all parameters and shared resources for the
 * simulation, including philosopher counts, timing, mutexes for 
 * synchronization, and flags for simulation termination.
 * * @param num_philo The total number of philosophers.
 * @param time_to_die The time (in milliseconds) a philosopher can go without
 * eating before dying.
 * @param time_to_eat The time (in milliseconds) it takes a philosopher to eat.
 * @param time_to_sleep The time (in milliseconds) it takes a philosopher to
 * sleep.
 * @param must_eat_count The number of times each philosopher must eat
 * (or -1 if not specified).
 * @param time_initial The starting timestamp of the simulation.
 * @param all_ate A flag to indicate if all philosophers have eaten enough.
 * (Note: `someone_died` is often used to terminate instead)
 * @param someone_died A flag to indicate if any philosopher has died, used to
 * stop the simulation.
 * @param philos A dynamically allocated array of philosopher structures.
 * @param forks A dynamically allocated array of mutexes, representing the
 * forks.
 * @param print_mutex A mutex to protect stdout during print operations.
 * @param state_mutex A mutex to protect shared simulation state
 * (e.g., `last_meal_time`, `someone_died`).
